...
enum MB_FC
{
    ...
    MB_FC_READ_COILS_               = 1, /*!< FCT=1 -> read coils or digital outputs */
    MB_FC_READ_DISCRETE_INPUT      = 2, /*!< FCT=2 -> read digital inputs */
    MB_FC_READ_REGISTERS           = 3, /*!< FCT=3 -> read registers or analog outputs */
    MB_FC_READ_INPUT_REGISTER      = 4, /*!< FCT=4 -> read analog inputs */
    MB_FC_WRITE_COIL_               = 5, /*!< FCT=5 -> write single coil or output */
...
public:
    Modbus_();
    Modbus_(uint8_t u8id, uint8_t u8serno);
    Modbus_(uint8_t u8id, uint8_t u8serno, uint8_t u8txenpin);
    Modbus_(uint8_t u8id);
 ...
 * @ingroup setup
 * @overload Modbus::Modbus_(uint8_t u8id, uint8_t u8serno)
 * @overload Modbus::Modbus_(uint8_t u8id)
 * @overload Modbus::Modbus_()
 */
Modbus_::Modbus_(uint8_t u8id, uint8_t u8serno)
{
    init(u8id, u8serno, 0);
}
 ...
 * @ingroup setup
 * @overload Modbus::Modbus_(uint8_t u8id, uint8_t u8serno, uint8_t u8txenpin)
 * @overload Modbus::Modbus_(uint8_t u8id)
 * @overload Modbus::Modbus_()
 */
Modbus_::Modbus_(uint8_t u8id, uint8_t u8serno, uint8_t u8txenpin)
{
 ...
 * @ingroup setup
 */
void Modbus_::begin(long u32speed)
{
 ...
 * @ingroup setup
 */
void Modbus_::begin(SoftwareSerial *sPort, long u32speed)
{
 ...
 * @ingroup setup
 */
void Modbus_::begin(long u32speed,uint8_t u8config)
{
 ...
 * @ingroup setup
 */
void Modbus_::setID( uint8_t u8id)
{
    if (( u8id != 0) && (u8id <= 247))
    {
        this->u8id = u8id;
 ...
 * @ingroup setup
 */
void Modbus_::setTimeOut( uint16_t u16timeOut)
{
 ...
 * @ingroup loop
 */
boolean Modbus_::getTimeOutState()
{
 ...
 */
int8_t Modbus_::query( modbus_t telegram )
{
 ...
 * @ingroup loop
 */
int8_t Modbus_::poll( uint16_t *regs, uint8_t u8size )
{
...
void Modbus_::init(uint8_t u8id, uint8_t u8serno, uint8_t u8txenpin)
{
    this->u8id = u8id;
...
void Modbus_::init(uint8_t u8id)
{
    this->u8id = u8id;
    this->u8serno = 4;
    this->u8txenpin = 0;
 ...
 * @ingroup buffer
 */
uint16_t Modbus_::calcCRC(uint8_t u8length)
{
 ...
 * @ingroup buffer
 */
uint8_t Modbus_::validateRequest()
{
 ...
 * @ingroup buffer
 */
uint8_t Modbus_::validateAnswer()
{
    // check message crc vs calculated crc
    uint16_t u16MsgCRC =
        ((au8Buffer[u8BufferSize - 2] << 8)
 ...
 * @ingroup buffer
 */
void Modbus_::buildException( uint8_t u8exception )
{
 ...
 * @ingroup discrete
 */
int8_t Modbus_::process_FC1( uint16_t *regs, uint8_t u8size )
{
 ...
 * @ingroup register
 */
int8_t Modbus_::process_FC3( uint16_t *regs, uint8_t u8size )
{
 ...
 * @ingroup discrete
 */
int8_t Modbus_::process_FC5( uint16_t *regs, uint8_t u8size )
{
 ...
 * @ingroup register
 */
int8_t Modbus_::process_FC6( uint16_t *regs, uint8_t u8size )
{
 ...
 * @ingroup discrete
 */
int8_t Modbus_::process_FC15( uint16_t *regs, uint8_t u8size )
{
 ...
 * @ingroup register
 */
int8_t Modbus_::process_FC16( uint16_t *regs, uint8_t u8size )
{
    uint8_t u8func = au8Buffer[ FUNC ];  // get the original FUNC code
